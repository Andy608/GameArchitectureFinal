...
void Game::render()
{
	GraphicsSystem::drawScaledToFit(0, 0, *mpAssetManager->getBuffer("background_buffer"), 
		GraphicsSystem::getDisplayWidth(), GraphicsSystem::getDisplayHeight());
	GraphicsSystem::draw(temp, 0, *mpAssetManager->getBuffer("balloon_buffer"), 1.0);
