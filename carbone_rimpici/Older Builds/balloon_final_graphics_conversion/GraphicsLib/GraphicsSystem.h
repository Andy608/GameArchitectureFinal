...
public:
	...
	static void draw(const int& drawingX, const int& drawingY, SDL_Surface& surface, const float& scale = 1.0f);
	static void draw(const GraphicsBuffer& targetBuffer, const int& drawingX, const int& drawingY, SDL_Surface& surface, const float& scale = 1.0f);
