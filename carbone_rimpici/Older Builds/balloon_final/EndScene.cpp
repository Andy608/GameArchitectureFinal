...
void EndScene::draw()
{
	...
	GraphicsSystem::writeTextCenteredHorizontally((int)*mpAssetManagerInstance->getValue("title_scene_menu_title_y"), *mpAssetManagerInstance->getFont("title_font"), *mpAssetManagerInstance->getColor("title_color"), mpLocalizationInstance->getLocalizedString("title_scene_menu_title"));
	GraphicsSystem::writeTextCenteredHorizontally((int)*mpAssetManagerInstance->getValue("title_scene_menu_subtitle_y"), *mpAssetManagerInstance->getFont("gui_font"), *mpAssetManagerInstance->getColor("text_color"), mpLocalizationInstance->getLocalizedString("title_scene_menu_subtitle"));
